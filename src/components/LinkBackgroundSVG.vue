<template>
<svg xmlns="http://www.w3.org/2000/svg" width="775.483" height="697" viewBox="0 0 775.483 697" class="LinkBackgroundSVG flex">
  <g id="Group_1" data-name="Group 1" transform="translate(-211 -199.518)" class="items-center">
